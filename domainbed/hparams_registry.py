...
def _hparams(algorithm, dataset, random_seed):
    ...
    _hparam('normalize', True, lambda r: True)
    _hparam('simple_augmentation', False, lambda r: False)
    ...
    if dataset == 'ColoredMNIST_10class':
        _hparam('mlp_dropout', 0.8, lambda r: r.choice([0., 0.1, 0.5, 0.8]))
